...
@given(scalar_strategy_strategy, concave_contour_size_pair_strategy)
def test_basic(
...
@given(scalar_strategy_strategy, invalid_concave_contour_size_pair_strategy)
...
@given(scalar_strategy_strategy, non_valid_concave_contour_size_pair_strategy)
