...
from ._core.base import (
    to_box_strategy as _to_boxes,
    to_concave_vertex_sequence_strategy as _to_concave_vertex_sequences,
    to_convex_vertex_sequence_strategy as _to_convex_vertex_sequences,
    to_empty_geometry_strategy as _to_empty_geometries,
    to_mix_strategy as _to_mixes,
    to_multicontour_strategy as _to_multicontours,
    to_multipoint_strategy as _to_multipoints,
    to_multipolygon_strategy as _to_multipolygons,
    ...
    to_vertex_sequence_strategy as _to_vertex_sequences,
)
...
def polygons(
    ...
    *,
    ...
    return _to_polygons(
        ...
        min_size=min_size,
        max_size=max_size,
        min_hole_count=max(min_holes_size, 0),
        max_hole_count=max_holes_size,
        ...
        (
            (
                _to_mixes(
                    x_coordinates,
                    y_coordinates,
                    min_point_count=max(min_points_size, 1),
                    max_point_count=max_points_size,
                    min_segment_count=max(min_segments_size, 1),
                    max_segment_count=max_segments_size,
                    min_polygon_count=min_polygons_size,
                    max_polygon_count=max_polygons_size,
                    min_polygon_border_size=min_polygon_border_size,
                    max_polygon_border_size=max_polygon_border_size,
                    min_polygon_hole_count=min_polygon_holes_size,
                    max_polygon_hole_count=max_polygon_holes_size,
                    min_polygon_hole_size=min_polygon_hole_size,
                    max_polygon_hole_size=max_polygon_hole_size,
                    context=context,
                )
                | _to_mixes(
                    ...
                    min_point_count=max(min_points_size, 1),
                    max_point_count=max_points_size,
                    min_segment_count=min_segments_size,
                    max_segment_count=max_segments_size,
                    min_polygon_count=max(min_polygons_size, 1),
                    max_polygon_count=max_polygons_size,
                    min_polygon_border_size=min_polygon_border_size,
                    max_polygon_border_size=max_polygon_border_size,
                    min_polygon_hole_count=min_polygon_holes_size,
                ...
                | _to_mixes(
                    x_coordinates,
                    y_coordinates,
                    min_point_count=min_points_size,
                    max_point_count=max_points_size,
                    min_segment_count=max(min_segments_size, 1),
                    max_segment_count=max_segments_size,
                    min_polygon_count=max(min_polygons_size, 1),
